...
} = useCollaboration(() => wsProvider, { userId, userName, userColor })
...
const shareUrl = computed(() => tunnelUrl.value || lanUrl.value || window.location.origin + '/#/canvas/' + canvasId.value)
